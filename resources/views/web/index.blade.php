             ...
             <div class="container">
                <div class="banner_taital_main">
                   <div class="row">
                      ...
                      <div class="col-md-6">
                         <div class="image_1"><img src="{{asset('web/images/img-1.png')}}"></div>
                      </div>
                   </div>
                </div>
             </div>
           ...
           <div class="services_section_2">
              ...
              <div class="col-md-6">
               <div class="image_main">
                  <img src="{{asset('uploads/courses')}}/{{$course->image}}" height="200" class="image_8" style="width:50%">
                  <div class="text_main">
        ...
        <div class="container">
           ...
           <div class="news_section_2">
              <div class="row">
                 ...
                 <div class="col-md-6">
                    <img src="{{asset('web/images/img-6.png')}}" class="image_6" style="width:100%">
     ...
     <div class="blog_section layout_padding">
        <div class="container">
           ...
           <div class="blog_section_2">
              <div class="row">
                 <div class="col-md-6">
                    <img src="{{asset('web/images/img-7.png')}}" class="image_7" style="width:100%">
                 </div>
                 <div class="col-md-6">
                 ...
                 <div class="container">
                    ...
                    <div class="client_section_2">
                       <div class="client_left">
                          <div><img src="{{asset('web/images/client-img.png')}}" class="client_img"></div>
                       </div>
     ...
     <div class="contact_section layout_padding">
        <div class="container-fluid">
           <div class="row">
              ...
              <div class="col-md-6">
                 <div class="map_main"><img src="{{asset('web/images/map-img.png')}}"></div>
              </div>
           </div>
        </div>
     </div>
